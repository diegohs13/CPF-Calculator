...
soma_primeiro_digito_verificador = (digito_1 * 10 + digito_2 * 9 + digito_3 * 8 + digito_4 * 7 + digito_5
                                    * 6 + digito_6 * 5 + digito_7 * 4 + digito_8 * 3 + digito_9 * 2) % 11

if soma_primeiro_digito_verificador == 0:
    primeiro_digito_verificador = 0

elif soma_primeiro_digito_verificador == 1:
    primeiro_digito_verificador = 0

else:
    primeiro_digito_verificador = 11 - soma_primeiro_digito_verificador


soma_segundo_digito_verificador = (digito_2 * 10 + digito_3 * 9 + digito_4 * 8 + digito_5 * 7 + digito_6
                                   * 6 + digito_7 * 5 + digito_8 * 4 + digito_9 * 3 +
                                   primeiro_digito_verificador * 2) % 11

if soma_segundo_digito_verificador == 0:
    segundo_digito_verificador = 0

elif soma_segundo_digito_verificador == 1:
    segundo_digito_verificador = 0

else:
    segundo_digito_verificador = 11 - soma_segundo_digito_verificador
